...
```mermaid
flowchart LR
   id1["user"] -- say (hello) -->  id2["Bot"] -- Hi!, Do you know 4+4? --> id3["Bot"]  -- Total: 8 --> id4["user"]
   style id1 fill:#ffa69e,stroke:#f79256,stroke-width:2px
   style id2 fill:#1dd3b0,stroke:#248277,stroke-width:2px
   style id3 fill:#1dd3b0,stroke:#248277,stroke-width:2px
   style id4 fill:#ffa69e,stroke:#f79256,stroke-width:2px
```
