...
```mermaid
fluxograma LR
   id1 (("user")) -- say (hello/hi) --> id2 (("Bot")) -- oi, bem vindo a minha loja incrível, como posso te ajudar? -- >id3 (("Bot")) -- a loja possui:, sapatos, camisas, calças e chapéus --> id4 (("usuário"))
   estilo id1 preenchimento:#ffa69e, traço:#f79256, largura do traço: 0px
   estilo id2 preenchimento:#1dd3b0, traçado:#248277, largura do traçado:0px
   estilo ID3 preenchimento:#1dd3b0, traçado:#248277, largura do traçado:0px
   estilo id4 preenchimento:#ffa69e, traço:#f79256, largura do traço:0px
```
---
