...
Before you start, you must make sure to have an API key from [OpenAI](https://platform.openai.com) and set your __OPENAI_API_KEY__ environment in your `.env` file.
...
If you have pnpm package manager run this way:
