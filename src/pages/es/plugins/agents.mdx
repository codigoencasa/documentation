...
<Note>
Antes de comenzar, debe asegurarse de tener una clave API de [OpenAI](https://platform.openai.com)
</Note>

## Install

Instala la librería para hacer uso de OpenAI:
...
__REFERENCIAS:__ [OpenAi-Agents](https://github.com/codigoencasa/bot-plugins/tree/feature/shopify/packages/openai-agents)
