...
flowchart LR
      subgraph sub1[ ]
        ...
        subgraph wsProvider[Provider Zone]
            direction TB
        ...
        wsProvider --> C{Decision}
        C --> zn1
        C --> zn2
        C --> zn3
        C --> zn4

        style zn1 fill:#ffccd5,stroke:#ff758f,stroke-width:1px
        style zn2 fill:#ffccd5,stroke:#ff758f,stroke-width:1px
        style zn3 fill:#ffccd5,stroke:#ff758f,stroke-width:1px
        style zn4 fill:#ffccd5,stroke:#ff758f,stroke-width:1px
